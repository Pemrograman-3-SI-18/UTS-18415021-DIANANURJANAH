            ...
            <div class="row no-wrap q-pa-lg">
              <div class="column">
                ...
                <div class="items-center">
                  <div class="text-bold items-center">D&A Jewelry</div>
                  <div>Berkilau Disetiap Saat</div>
                </div>
              </div>
        ...
        <q-list>
          ...
          <q-item class="justify-center text-center q-mb-md q-pt-md">
            <div>
              ...
              <div class="text-weight-bold">D&A Jewelry</div>
              <div>Berkilau Disetiap Saat</div>
            </div>
          </q-item>
          <q-item-label
          ...
          <q-item clickable active-class="active" exact v-ripple to="/admin/inputdataperhiasan">
            <q-item-section avatar>
